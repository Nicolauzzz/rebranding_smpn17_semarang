...
<head>
    ...
    <title>Galeri SMPN 17 Semarang</title>
</head>
...
<div class="min-h-full">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="/ppdb" class="rounded-md px-3 py-2 text-sm font-medium text-blue-950 hover:bg-blue-950 hover:text-white" style="white-space: nowrap;">PPDB 2024/2025</a>
    ...
    <header class="bg-blue-950" style="box-shadow: 0 -5px 25px -5px rgba(36,83,253,0.5);">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-white">Beranda</h1>
        </div>
    </header>
