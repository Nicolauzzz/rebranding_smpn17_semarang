...
<head>
    ...
    <style>
        /* Aturan untuk latar belakang */
        body {
            background-image: url('https://wallpapercave.com/wp/wp8538129.jpg'); /* Ganti dengan URL gambar yang Anda inginkan */
    ...
    <div>
        <header class="bg-blue-950" style="box-shadow: 0 -5px 25px -5px rgba(36,83,253,0.5);">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-white">Kontak & Pengaduan</h1>
            </div>
        </header>
    </div>
